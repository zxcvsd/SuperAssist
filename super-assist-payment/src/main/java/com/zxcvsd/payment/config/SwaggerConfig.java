package com.zxcvsd.payment.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.zxcvsd.payment"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .title("swagger接口文档")
                //文档描述
                .description("交易支付中心接口文档")
                //版本号
                .version("0.0.1")
                //服务条款URL
                .termsOfServiceUrl("http://localhost:12002/")
                .build();
    }
